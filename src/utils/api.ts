import { projectId, publicAnonKey, BASE_URL } from '../utils/supabase/info';
...
export const busAPI = {
  ...
  create: (data: any) => fetchAPI('/buses', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id: string, data: any) => fetchAPI('/buses', {
    method: 'POST',
    body: JSON.stringify({ id, ...data }),
  }),
  delete: (id: string) => fetchAPI(`/buses/${id}`, { method: 'DELETE' }),
  getAlert: (busId: string) => fetchAPI(`/buses/${busId}/alert`),
  setAlert: (busId: string, data: any) => fetchAPI(`/buses/${busId}/alert`, {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  clearAlert: (busId: string) => fetchAPI(`/buses/${busId}/alert`, { method: 'DELETE' }),
  updateLocation: (busId: string, location: { lat: number; lng: number }) => fetchAPI(`/buses/${busId}/location`, {
    method: 'PUT',
...
export const tripAPI = {
  ...
  create: (data: any) => fetchAPI('/trips', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id: string, data: any) => fetchAPI(`/trips/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
...
export const passengerAPI = {
  ...
  add: (tripId: string, data: any) => fetchAPI(`/trips/${tripId}/passengers`, {
    method: 'POST',
    body: JSON.stringify(data),
  }),
...
export const lostItemAPI = {
  ...
  create: (data: any) => fetchAPI('/lostitems', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  update: (id: string, data: any) => fetchAPI(`/lostitems/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
...
export const routeAPI = {
  ...
  create: (data: any) => fetchAPI('/routes', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
};