...
import { MapPin, Clock, Users, Bus, Navigation, Star } from 'lucide-react';
                  ...
                  <div key={bus.id} className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 text-gray-600 text-sm">
                        ...
                        <span>{bus.currentPassengers}/{bus.maxCapacity} passengers</span>
                      </div>
                ...
                <div key={index} className="flex items-start gap-4 pb-6 last:pb-0">
                  <div className="relative flex flex-col items-center">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm ${
                      ...
                      index === selectedRoute.stops.length - 1 ? 'bg-red-500 text-white' :
                  ...
                  <div className="flex-1 pt-1">
                    ...
                    {index === selectedRoute.stops.length - 1 && <p className="text-red-600 text-sm">Final Destination</p>}
                  </div>
                </div>
              ))}
            </div>
