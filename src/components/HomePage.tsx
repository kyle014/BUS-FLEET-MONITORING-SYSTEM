import { Bus, Users, Shield, Ticket } from 'lucide-react';
      ...
      <section className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 w-full">
          ...
          >
            ...
            >
              Integrated Bus Fleet Monitoring with QR Code Tracking       
              for Passengers on the Dasmariñas, Cavite to Alabang, Muntinlupa City route 
            </motion.p>
